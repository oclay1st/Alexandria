...
export default {
    ...
    data() {
        let that = this,
            ...
            langBag = {
                es: {
                    hint: 'Click, o arrastre el archivo hasta aquí',
                    loading: 'Subiendo……',
                    noSupported: 'Tu navegador no es soportado, por favor usa IE10+ u otro navegador',
                    success: 'Subida satisfactoria',
                    fail: 'Subida fallida',
                    ...
                    error: {
                        onlyImg: 'Solo imágenes',
                        outOfSize: 'La imagen excede el limite: ',
                        lowestPx: 'El valor minimo de pixel en la imagen: '
                    }
                },   
                en: {
